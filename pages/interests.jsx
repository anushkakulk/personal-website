          ...
          <div className="max-w-5xl mx-auto text-center">
            <div className="space-y-6">
              ...
              <p className="text-base md:text-lg text-slate-600 leading-relaxed">
                In my free time, I love consuming media, whether it be reading a
                new historical fiction book or creating random but perfectly
                collated music playlists. Here's what I'm diving into at the
                moment!
              </p>
            </div>
          </div>
              ...
              <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div>
                  ...
                  <p className="text-sm text-slate-500 mt-1">
                    These are the songs I’ve been listening to most over the
                    last 30 days.
                  </p>
                </div>
              ...
              >
                <div className="carousel-item">
                  ...
                  <p className="legend text-xs sm:text-lg font-bold mt-2 ">
                    <i>My Brilliant Friend</i>, set in the 1950s, is the first
                    of
                    ...
                    their adolescene, <i>MBF</i> really immerses you in the era;
                ...
                <div className="carousel-item">
                  ...
                  <p className="legend text-sm sm:text-lg font-bold mt-2 ">
                    Read in the summer before college, <i>No Exit</i> was a
                    great look into the chaos of existentialism. Short and
                    sweet, it really packs a punch. Truly left me thinking
                    "huh... cool".{" "}
                  </p>
                </div>
                <div className="carousel-item">
                  ...
                  <p className="legend text-sm sm:text-lg font-bold mt-2">
                    ...
                    was in 9th grade. I loved the drama, the dark and dreary
                    vibe, the detail on mundane affairs. I definitely found it a
                    very approachable read for being a 'classic,' and am
                    currently in the middle of a re-read.{" "}
                  </p>
                </div>
              </Carousel>
            </div>
