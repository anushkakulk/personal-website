...
const experience = [
    ...
    bullets: [
      {
        ...
        highlight: "NVIDIA Jetson Orin",
      },
      {
        text: "Automated motor-based 2D/3D camera calibration system, achieving 40% faster alignment and reprojection error under 0.02 px",
        highlight: "40% faster alignment",
      },
    ],
  },
  {
    ...
    bullets: [
      {
        ...
        highlight: "NVIDIA GB300 liquid-cooled GPU servers",
      },
      {
  ...
  },
  {
    ...
    bullets: [
      ...
      {
        text: "Benchmarked Kalman filtering and ML-based image processing, achieving 50% faster processing than Mars 2020",
        highlight: "50% faster processing",
      },
    ],
  },
];
...
const skillsList = [
  {
    ...
    Icon: FaPython,
    proficiency: 92,
    note: "Amazon, Meta, JPL, coursework",
  },
  {
    name: "C / C++",
    Icon: SiCplusplus,
    proficiency: 85,
    note: "Sensor drivers, flight software, AerospaceNU",
  },
  {
    name: "Java",
    Icon: FaJava,
    proficiency: 80,
    note: "Object-Oriented Design, Fundamentals",
  },
  {
    name: "ROS2",
    Icon: SiRos,
    proficiency: 78,
    note: "SLAM, motion planning, robot control",
  },
  {
    name: "PyTorch",
    Icon: SiPytorch,
    proficiency: 75,
    note: "Robot Grasp CNN, ML and NLP coursework",
  },
  {
    name: "JavaScript / TS",
    Icon: IoLogoJavascript,
    proficiency: 72,
    note: "This site :) and SE coursework",
  },
  {
    name: "Docker",
    Icon: SiDocker,
    proficiency: 70,
    note: "Microservices at Amazon and Meta",
  },
  {
    name: "SQL",
    Icon: SiMysql,
    proficiency: 65,
    note: "Database Design, Meta health checks",
  },
];
        ...
        {open && (
          <ul className="mt-3 pt-3 border-t border-slate-100 flex flex-col gap-2">
            {item.bullets.map((b, i) => (
              <li
                key={i}
                className="text-sm text-slate-500 leading-relaxed pl-3 relative"
              >
    ...
    <div id="skills" className="w-full py-20 px-4 sm:px-6">
      <div className="mx-auto max-w-[1240px]">
        <div className="space-y-12">
          <section>
            <div className="mb-6">
              <p className="text-lg uppercase tracking-[0.3em] text-[#3F8B7D]">
                Experience
              </p>
            </div>
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {group.items.map((item) => (
                      <span
                        key={item}
                        className="text-sm text-slate-600 bg-slate-100 border border-slate-200 rounded-full px-3 py-1.5"
                      >
                        {item}
                      </span>
                    ))}
